...
def main():
    ...
    df_result = pd.DataFrame(bechmark_result,
                             columns=['Dataset', 'F1_measure', 'Accuracy', 'Msg_Accuracy', 'Edit_Distance_Mean',
                                      'Edit_Distance_Std'])
...
def evaluate_message_level(groundtruth, parsedresult):
    ...
    print('Message-Level Accuracy: %.4f, Edit Distance Mean: %.4f, Edit Distance Std: %.4f' % (msg_accuracy, edit_distance_mean, edit_distance_std))
